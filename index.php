<?php
$loginUrl = file_exists(__DIR__ . '/tmhis/public/index.php') ? 'tmhis/public/login' : '/login';
$appointmentUrl = file_exists(__DIR__ . '/tmhis/public/index.php') ? 'tmhis/public/register/intake' : '/register/intake';
?>
<!DOCTYPE html>
    ...
    <header id="navbar" class="sticky-header fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 transition-all duration-300">
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20 gap-4">
                ...
                <div class="hidden md:flex items-center gap-4 xl:gap-6 shrink-0">
                    ...
                    <a href="<?= $appointmentUrl ?>" class="inline-flex items-center justify-center px-5 xl:px-6 py-2.5 xl:py-3 rounded-full bg-blue-600 text-white font-semibold text-sm whitespace-nowrap shadow-md shadow-blue-500/20 hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-200">
                        Book Appointment
                    </a>
                </div>
                ...
                <div class="flex lg:hidden items-center gap-3">
                    <a href="<?= $appointmentUrl ?>" class="md:hidden px-4 py-2 rounded-full bg-blue-600 text-white text-xs font-semibold whitespace-nowrap">
                        Book Now
                    </a>
        ...
        <div id="mobileMenu" class="hidden lg:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-6 space-y-3 shadow-xl">
            ...
            <div class="pt-4 border-t border-slate-100 flex flex-col gap-3">
                ...
                <a href="<?= $appointmentUrl ?>" class="mobile-menu-link text-center px-4 py-3 rounded-xl bg-blue-600 text-white font-semibold text-sm">
                    Book Appointment
                </a>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="lg:col-span-6 space-y-6 lg:space-y-8" data-aos="fade-right">
                        ...
                        <div class="flex flex-wrap items-center gap-4 pt-2" data-aos="fade-up" data-aos-delay="200">
                            <a href="<?= $appointmentUrl ?>" class="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-blue-600 text-white font-bold text-base shadow-lg shadow-blue-600/25 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/35 transition-all duration-200 group">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800">
                ...
                <div class="lg:col-span-2 space-y-3">
                    ...
                    <ul class="space-y-2 text-sm text-slate-400">
                        <li><a href="<?= $appointmentUrl ?>" class="hover:text-white transition-colors">Book Appointment</a></li>
