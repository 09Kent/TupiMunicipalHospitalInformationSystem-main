    ...
    public function getQueueStats(): array
    {
        $stmt = $this->db->query("
            SELECT 
                ...
                SUM(CASE WHEN QueueStatus = 'In Consultation' THEN 1 ELSE 0 END) as in_consultation,
                SUM(CASE WHEN QueueStatus = 'Completed' THEN 1 ELSE 0 END) as completed,
                SUM(CASE WHEN QueueStatus = 'Cancelled' THEN 1 ELSE 0 END) as cancelled
            FROM patient_queue 
            WHERE QueueDate = CURDATE()
        ");
        ...
        return [
            ...
            'in_consultation' => (int)($row['in_consultation'] ?? 0),
