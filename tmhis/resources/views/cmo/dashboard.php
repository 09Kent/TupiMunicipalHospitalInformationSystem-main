      ...
      <section class="view-section active" id="view-dashboard">
        ...
        <div class="cards-grid" id="summaryCards">
          <div class="card summary-card c-primary">
            ...
            <div class="sc-value" id="cardCensus"><?= $metrics['census'] ?? 126 ?></div>
            <div class="sc-bottom">
          ...
          <div class="card summary-card c-indigo">
            ...
            <div class="sc-value" id="cardRevenue">₱<?= number_format((float)($metrics['revenue'] ?? 1284500), 2) ?></div>
            <div class="sc-bottom">
