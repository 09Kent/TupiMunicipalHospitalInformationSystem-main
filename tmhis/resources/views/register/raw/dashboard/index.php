...
// Fetch Real MySQL Stats
$kpis = $reportModel->getDashboardKPIs();
$recentPatients = $patientModel->getPaginated(6, 0);
...
$activeNav = 'dashboard';
$pageTitle = 'Dashboard | Tupi Municipal Hospital Information Management System';
...
<main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8">
  ...
  <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-blue-600/15 relative overflow-hidden">
    ...
    <div class="relative z-10 flex flex-wrap items-center gap-3 shrink-0">
      <a href="<?= base_url('views/registration/index.php') ?>" 
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-2xs space-y-6 flex flex-col justify-between">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between pb-3 border-b border-slate-100">
          ...
          <a href="<?= base_url('views/queue/index.php') ?>" class="text-xs text-blue-600 font-bold hover:underline">Manage Queue</a>
        </div>
      ...
      <div class="pt-3 border-t border-slate-100">
        <a href="<?= base_url('views/queue/index.php') ?>" class="w-full py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition flex items-center justify-center gap-2">
    ...
    <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-2xs space-y-4 lg:col-span-2">
      ...
      <div class="flex items-center justify-between pb-3 border-b border-slate-100">
        ...
        <a href="<?= base_url('views/appointments/index.php') ?>" class="text-xs text-blue-600 font-bold hover:underline">View All Schedule</a>
      </div>
  ...
  <div class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-2xs space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
      ...
      <div class="flex items-center gap-3">
        <a href="<?= base_url('views/patients/index.php') ?>" class="text-xs font-bold text-blue-600 hover:text-blue-700 flex items-center gap-1">
          ...
          <?php foreach ($recentPatients as $pat): ?>
            <tr class="hover:bg-slate-50/70 transition">
              <td class="py-3.5 font-mono font-bold text-blue-700">
                <a href="<?= base_url('views/patients/view.php?id=' . $pat['PatientID']) ?>" class="hover:underline">
                  <?= e($pat['PatientCode']) ?>
                </a>
              </td>
              <td class="py-3.5">
