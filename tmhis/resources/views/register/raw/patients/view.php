...
if (!$patient) {
    die("<h1>Patient Not Found</h1><p>The requested patient record could not be found.</p><a href='" . base_url('views/patients/index.php') . "'>Return to Patients</a>");
}

$activeNav = 'patients';
$pageTitle = 'Patient Profile: ' . e($patient['FirstName'] . ' ' . $patient['LastName']) . ' (' . e($patient['PatientCode']) . ')';
